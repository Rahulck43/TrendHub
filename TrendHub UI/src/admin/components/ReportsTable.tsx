                                            ...
                                            <tr key={report?._id}  >
                                                ...
                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <div className="flex items-center gap-4">
                                                        <svg onClick={() => handleBlock(report.post._id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer ease-in-out hover:text-red-600 transform hover:scale-110 rounded transition-all duration-300">
